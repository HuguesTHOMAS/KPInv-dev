...
#
#
#   Use this script to train a network on ScanNetV2 using the simple input pipeline 
...
if __name__ == '__main__':
    ...
    cfg.data.update(ScanNetV2_cfg(cfg).data)
    ...
    training_dataset = ScanNetV2Dataset(cfg,
                                    chosen_set='training',
