...
declare -a arg_arr=("--conv_groups 8 --use_strided_conv 0 --first_inv_layer 0 --kp_mode transformer"
                    "--conv_groups 8 --use_strided_conv 1 --first_inv_layer 0 --kp_mode transformer"
                    "--conv_groups 1 --use_strided_conv 1 --first_inv_layer 0 --kp_mode transformer"
                    "--conv_groups 1 --use_strided_conv 1 --first_inv_layer 2 --kp_mode transformer"
                    "--conv_groups 1 --use_strided_conv 0 --first_inv_layer 0 --kp_mode inv_v3"
                    "--conv_groups 8 --use_strided_conv 0 --first_inv_layer 0 --kp_mode inv_v3"
                    "--conv_groups 1 --use_strided_conv 1 --first_inv_layer 0 --kp_mode inv_v3"
                    "--conv_groups 1 --use_strided_conv 1 --first_inv_layer 1 --kp_mode inv_v3"
                    "--conv_groups 1 --use_strided_conv 1 --first_inv_layer 2 --kp_mode inv_v3"
                    "--conv_groups 1 --use_strided_conv 1 --first_inv_layer 3 --kp_mode inv_v3")
